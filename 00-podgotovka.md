...
Первое, с чего удобно начинать, — раскидать нужный софт на все виртуальные машины с Windows. Софт и ключи удобно копировать через общую папку VMware. Варианты:
...
Для выдачи правильных IP-адресов нужно знать, сколько адресов и какие можно выдавать по маске. Для этого можно воспользоваться любым онлайн IP-калькулятором, например:

```
https://ip-calculator.ru/#!ip=172.20.30.0/26
```
...
| ⬅️ Назад | 🏠 | Вперёд ➡️ |
|---|---|---|
| [Главная](README.md) | [Содержание](README.md) | [Задание 1.1 — MSSQL](01-zadanie-1-1-mssql.md) |
