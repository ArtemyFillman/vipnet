...
> ⚠️ **Сверено с PDF.** Дословные пути в тексте инструкции есть только для **ЦУС-сервера, ЦУС-клиента, УКЦ и ViPNet Client** — они совпадают с таблицей выше. Путь к **MS SQL** взят со скриншота (установщик лежит внутри дистрибутива ViPNet). Для **Registration Point / Publication Service / CA Informing** полного пути установки в PDF нет — на скриншотах видны только их папки на Рабочем столе (имена указаны выше).
>
